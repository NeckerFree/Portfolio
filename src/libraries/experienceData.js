...
const superSociedadesExperience = {
  ...
  functions: [
    ...
    'Created a new version of Web.API web services using JWT authentication and Swagger,'
    + 'developed the new required methods and migrated existing SQL queries to web methods and deployed'
    + 'REST services to production.',
  ...
  projects: [
    {
      ...
      technologies: ['.NET C#', 'SOAP Web Services', 'REST Web Services',
        'ASPX.NET MVC', 'Entity Framework', 'Informix DB', 'SQL Server DB'],
      gitUrl: '',
